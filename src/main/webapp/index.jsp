...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${app:contextPath(pageContext.request)}/wro/css/techsoft.css" />

    <script type="text/javascript">
        var application_title = '${app:title()}';
    </script>
</head>
...
<body>
    ...
    <script type="text/javascript" src="${app:contextPath(pageContext.request)}/wro/js/techsoft.js"></script>
